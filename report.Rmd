...
![]("~/project/figures/themes.png"){width=75%}

Figure 5: COVID-19 Vaccination Rate vs. Overall SVI

![]("~/project/figures/themes_aug1.png"){width=75%}

Figure 6: Change in COVID-19 Vaccination Rate from August 1 vs. Overall SVI
